...
$global_config['ftp_user_pass'] = 'TTDs_VoAR31YC_4o0w9VMw,,';
...
$global_config['my_domains'] = 'www.kenmei.honguyen.info,localhost,dulich.honguyen.info';
...
$global_config['rewrite_op_mod'] = 'trang-chu';
$global_config['rewrite_optional'] = 1;
$global_config['session_prefix'] = 'nv4s_i9iz31';
...
$global_config['timestamp'] = 1716542873;
...
$language_array = ['en' => ['name' => 'English', 'language' => 'English'], 'fr' => ['name' => 'Français', 'language' => 'French'], 'ja' => ['name' => '日本語', 'language' => 'Japanese'], 'vi' => ['name' => 'Tiếng Việt', 'language' => 'Vietnamese']];

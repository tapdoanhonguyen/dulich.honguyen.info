...
if (!nv_function_exists('nv_block_config_life')) {
    /**
     * nv_block_config_life_setting()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_life_setting($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_life_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_life_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    /**
     * nv_block_config_life()
     *
     * @param array $block_config
     * @return string|void
     */
    function nv_block_config_life($block_config)
    {
        ...
        if (!empty($list)) {
            $xtpl = new XTemplate('block_life.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_info['module_theme']);
...
if (defined('NV_SYSTEM')) {
    ...
    $content = nv_block_config_life($block_config);
}

...
if (!nv_function_exists('nv_news_block_travel')) {
    /**
     * nv_block_config_travel()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_travel($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_travel_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_travel_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    /**
     * nv_news_block_travel()
     *
     * @param array $block_config
     * @return string|void
     */
    function nv_news_block_travel($block_config)
    {
        ...
        if (!empty($list)) {
            $xtpl = new XTemplate('block_travel.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_info['module_theme']);
...
if (defined('NV_SYSTEM')) {
    ...
    $content = nv_news_block_travel($block_config);
}
